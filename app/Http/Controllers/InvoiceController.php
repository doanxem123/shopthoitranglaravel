...
class InvoiceController extends Controller
{
	public function invoice(){
		...
		*/
		...
		return view('pages.invoice.invoice',['filter' => $invoice])->with('category',$category_product)->with('brand',$brand_product)->with('invoice',$invoice);
	}
	...
	public function details_invoice($invoice_id){
		...
		$invoice = DB::table('tbl_invoice')->join('tbl_discount','tbl_invoice.discount_id','=','tbl_discount.discount_id')->where('invoice_id',$invoice_id);
		...
		return view('pages.invoice.details_invoice')->with('category',$category_product)->with('brand',$brand_product)->with('invoice',$invoice->get())->with('details_invoice',$details_invoice)->with('invoice_permission',$invoice_permission);
	}
	...
	public function update_invoice(Request $request){
		...
		$data_update['invoice_status'] = $request->send_status;
